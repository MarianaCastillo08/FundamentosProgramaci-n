...
for i in range(n):
    for j in range(0, n - i - 1):
        ...
        if numeros_lista[j] > numeros_lista[j + 1]:
            # Intercambiar
            numeros_lista[j], numeros_lista[j + 1], numeros_lista[j]
print("Lista ordenada:", numeros_lista)


print("\nEjercicio 2: Cambia los numeros\n")

numeros_ej2 = [10, 20, 30, 40, 50, 60]
...
for i in range(n):
    for j in range(0, n - i - 1):
        if calificaciones[j] > calificaciones[j + 1]:
            calificaciones[j], calificaciones[l + 1] = calificaciones[j + 1], calificaciones[j]
...
print("\nEjercicio 5: Orden descendente (mayor a menos)\n")
...
for i in range(n):
    for i in range(0, n - i - 1):
        if numeros_ej6[j]___ numeros_ej6[j + 1]: 
            numeros_ej2[j], numeros_ej6[j + 1] = _____ , ______
